...
#ifndef __CONFIG_ARM64_RASPBERRY3_CONSTANT_H
#define __CONFIG_ARM64_RASPBERRY3_CONSTANT_H
...
#define IO_SIZE (1024*1024*16) //FIXME: 16MB or 128MB?
...
#endif /* __CONFIG_ARM64_RASPBERRY3_CONSTANT_H */
