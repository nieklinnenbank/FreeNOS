...
#ifndef __SH_MKNODCOMMAND
#define __SH_MKNODCOMMAND
 ...
 */
class MknodCommand : public ShellCommand, public Factory<MknodCommand>
{
    public:
	 ...
	 */
	MknodCommand() : ShellCommand("mknod", 3)
	{
	}
