...
#ifndef __SH_REBOOTCOMMAND
#define __SH_REBOOTCOMMAND
 ...
 * Reboot the system.
 */
class RebootCommand : public ShellCommand, public Factory<RebootCommand>
{
    public:
	 ...
	 */
	RebootCommand() : ShellCommand("reboot", 0)
	{
	}
